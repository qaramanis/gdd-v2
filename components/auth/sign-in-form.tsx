  ...
  return (
    <div className="relative flex items-center justify-center h-screen w-screen">
      ...
      <div className="h-150 w-250 rounded-xl flex items-center justify-center">
        <div className="w-110 h-full text-background bg-foreground/90 flex flex-col p-12 justify-between rounded-xl">
          ...
          <div>
            ...
            <div className="flex flex-col gap-4">
              ...
              <button
                type="submit"
                className="w-full h-10 text-foreground bg-background/85 hover:bg-background/65 flex items-center justify-center transition-all duration-300 rounded-lg"
                disabled={loading}
                onClick={async () => {
                  await signIn.email(
                    {
            ...
            <div className="w-full flex flex-row items-center justify-center text-center my-4">
              ...
              <div className="w-4/10 -mt-1 text-accent">or sign in via</div>
              <div className="w-3/10 h-px bg-accent"></div>
            </div>
            <div className="flex flex-row gap-2 items-center justify-center text-center my-4">
              <a className="w-full h-10 bg-accent/20 hover:bg-accent/30 flex items-center justify-center transition-all duration-300 rounded-lg">
                <svg
        ...
        {/*<div className="w-140 h-full bg-white/10 rounded-r-xl border-t border-b border-r border-background"></div>*/}
      </div>
    </div>
  );
}
